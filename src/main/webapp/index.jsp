...
<%--                              <li><a href="famms-1.0.0/about.html">About</a></li>--%>
<%--                              <li><a href="famms-1.0.0/testimonial.html">Testimonial</a></li>--%>
<%--                           </ul>--%>
<%--                        </li>--%>
                        <li class="nav-item">
                           <a class="nav-link" href="store.jsp">Go To Store</a>
<%--                        </li>--%>
<%--                        <li class="nav-item">--%>
<%--                           <a class="nav-link" href="famms-1.0.0/blog_list.html">Blog</a>--%>
<%--                        </li>--%>
<%--                        <li class="nav-item">--%>
<%--                           <a class="nav-link" href="famms-1.0.0/contact.html">Contact</a>--%>
<%--                        </li>--%>
                        <li class="nav-item">
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 ...
                                 <p>
                                    Discover the essence of style with our online fashion store, where trend meets tradition in a curated collection of fashionable wears. From the streets to the soirees, our selections are designed to elevate your wardrobe with a blend of timeless elegance and contemporary flair.
                                 </p>
                                 <div class="btn-box">
                                    <a href="store.jsp">
                                    Shop Now
